...
### last modified on: Wednesday, March 16, 2011 at 19:09
...
#1. Group medians 2. Wilcoxon-test for between-group differences in median (after the median adjustment if specified) 3. Unique values of x and their tie-adjusted Siegel-Tukey ranks 4. Xs of group 1 and their tie-adjusted Siegel-Tukey ranks 5. Xs of group 2 and their tie-adjusted Siegel-Tukey ranks 6. Siegel-Tukey test (Wilcoxon test on tie-adjusted Siegel-Tukey ranks)
