...
for ii = 1:length(leaf)
   ...
   % error 'oobError'
   b = TreeBagger(nTrees,X_train,y_train,'oobpred','on','OOBVarImp','on','cat',6,'minleaf',leaf(ii),'NVarToSample','all');
...
%%%%%%%%%%%Prediction%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
b = TreeBagger(nTrees,X_train,y_train,'oobpred','on','OOBVarImp','on','cat',6,'minleaf',leaf(3),'NVarToSample','all');
